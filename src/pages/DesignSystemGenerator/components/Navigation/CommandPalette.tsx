...
const commandItems: CommandItem[] = [
    ...
    { label: 'Badge / Tag', path: '/design-system-generator/components/badge', icon: ComponentIcon, category: 'Components', keywords: ['label', 'chip', 'tag'] },
    { label: 'Avatar', path: '/design-system-generator/components/avatar', icon: ComponentIcon, category: 'Components', keywords: ['user', 'profile', 'image'] },
    { label: 'Alert', path: '/design-system-generator/components/alert', icon: ComponentIcon, category: 'Components', keywords: ['warning', 'error', 'info', 'notification'] },
    { label: 'Toast / Snackbar', path: '/design-system-generator/components/toast', icon: ComponentIcon, category: 'Components', keywords: ['notification', 'snackbar', 'message'] },
    { label: 'Spinner & Progress', path: '/design-system-generator/components/spinner', icon: ComponentIcon, category: 'Components', keywords: ['loading', 'progress', 'spin'] },
    { label: 'Tabs', path: '/design-system-generator/components/tabs', icon: ComponentIcon, category: 'Components', keywords: ['navigation', 'panel', 'switch'] },
    { label: 'Breadcrumb', path: '/design-system-generator/components/breadcrumb', icon: ComponentIcon, category: 'Components', keywords: ['navigation', 'path', 'crumb'] },
    { label: 'Table / Data Grid', path: '/design-system-generator/components/table', icon: ComponentIcon, category: 'Components', keywords: ['data', 'grid', 'list', 'sort'] },
    { label: 'Select / Dropdown', path: '/design-system-generator/components/select', icon: ComponentIcon, category: 'Components', keywords: ['dropdown', 'combobox', 'search'] },
